...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="{{ url('assets/css/gaya.css')}}">
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="index.html" class="logo"><b>DIGITAL LIBLARY VHS 13 BDG</b></a>
            <!--logo end-->
...
<li><a class="logout" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="fa fa-sign-out pull-right"></i>Logout</a>
      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="mt">
                      <a class="{{ Request::is('liblary') ? 'active' : '' }}" href="{{('/liblary')}}">
...
@yield('content')
  ...
  <script src="{{ url('assets/js/zabuto_calendar.js')}}"></script>  
   ...
   <script type="text/javascript">
    ...
    $('#nama_buku').val($(this).data('nama_buku'));
    $('#slug').val($(this).data('slug'));
    $('#foto_buku').val($(this).data('foto_buku'));
    $('#pengarang').val($(this).data('pengarang'));
    $('#penerbit').val($(this).data('penerbit'));
    $('#thn_terbit').val($(this).data('thn_terbit'));
    $('#jenis').val($(this).data('jenis'));
    $('#jml_buku').val($(this).data('jml_buku'));
